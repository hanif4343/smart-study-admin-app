...
/* ══════════════════════════════════════════════════════════════════
   ...
   GitHub Token localStorage-এ সেভ থাকে, এই ডিভাইসেই।
   ══════════════════════════════════════════════════════════════════ */
  ...
  return(
    <div style={{paddingBottom:24}}>
      ...
      <div style={{display:"flex",justifyContent:"flex-end",marginBottom:8}}>
        <button className="icon-btn" title="GitHub Action সেটিংস" onClick={()=>setShowCfg(v=>!v)} style={showCfg?{background:C.accent,color:"#fff",borderColor:C.accent}:undefined}>⚙️</button>
      </div>
