...
১. হেডার থেকে designation, institution ও year (সাল, ৪-ডিজিট, বাংলা/ইংরেজি সংখ্যায় যা-ই থাকুক ইংরেজি সংখ্যায় দাও) আলাদা করে বের করো। "Written" শব্দ, পাতা নম্বর, "তারিখ/সময়/পূর্ণমান" — এসব বাদ দাও।
   ...
   — ⚠️ খুব গুরুত্বপূর্ণ পার্থক্য — বইয়ের/সিরিজের নিজস্ব নাম (masthead) বনাম আসল exam-এর designation/institution গুলিয়ে ফেলো না। এই ধরনের সংকলন বইয়ে (যেমন "অর্কিড বিগত সালের প্রশ্ন ব্যাংক", "প্রশ্ন ও সমাধান" সিরিজ) প্রায় প্রতিটা পাতাতেই একটা রিপিটিং banner/masthead লাইন ছাপা থাকে — এটা বইয়ের নাম, কোনো exam-এর designation না, কখনোই designation/institution হিসেবে বসিও না। চেনার উপায়:
     · যদি লাইনে "প্রশ্ন ব্যাংক", "প্রশ্ন ও সমাধান", "সালের প্রশ্ন", "কালেকশন", "সংকলন", "গাইড", "সাজেশন" এই ধরনের শব্দ থাকে → এটা বইয়ের নাম/masthead, designation/institution না।
     · আসল designation সবসময় একটা বাস্তব চাকরির পদবী (যেমন: সহকারী, কর্মকর্তা, শিক্ষক, চালক, পরিদর্শক, ক্লার্ক, অফিসার, ইন্সপেক্টর ইত্যাদি শব্দ থাকে) এবং প্রায়ই তার ঠিক পাশে "পদে নিয়োগ"/"নিয়োগ পরীক্ষা"/সাল লেখা থাকে।
     · আসল institution একটা বাস্তব সরকারি/বেসরকারি প্রতিষ্ঠান/দপ্তর/ব্যাংকের নাম।
     · একই পাতায় একাধিক হেডার-সদৃশ লাইন থাকলে (একটা বইয়ের masthead + একটা আসল exam-হেডার), শুধু আসল exam-হেডার থেকেই designation/institution নাও, masthead-টা সম্পূর্ণ উপেক্ষা করো।
     · উদাহরণ: পাতায় পরপর তিন লাইনে "অর্কিড বিগত সালের প্রশ্ন ব্যাংক" / "পল্লী সঞ্চয় ব্যাংক" / "ক্যাশ সহকারী পদে নিয়োগ ২০১৮" থাকলে → designation="ক্যাশ সহকারী", institution="পল্লী সঞ্চয় ব্যাংক", year="2018" (প্রথম লাইনটা ("অর্কিড বিগত সালের প্রশ্ন ব্যাংক") বইয়ের masthead — এটা designation/institution কোথাও বসাবে না)।
...
১. হেডার থেকে designation, institution ও year (সাল, ৪-ডিজিট, বাংলা/ইংরেজি সংখ্যায় যা-ই থাকুক ইংরেজি সংখ্যায় দাও) আলাদা করে বের করো। "MCQ" শব্দ, পাতা নম্বর, "তারিখ/সময়/পূর্ণমান" — এসব বাদ দাও। হেডারের বানান/OCR কিছুটা garbled হলেও best-effort extract করো। কোনো heading-ই না থাকলে "" খালি দাও।
   — ⚠️ বইয়ের/সিরিজের নিজস্ব নাম (masthead) বনাম আসল exam-এর designation/institution গুলিয়ে ফেলো না। সংকলন বইয়ে (যেমন "অর্কিড বিগত সালের প্রশ্ন ব্যাংক") প্রায় প্রতিটা পাতাতেই একটা রিপিটিং banner/masthead লাইন থাকে — এটা বইয়ের নাম, কখনোই designation/institution হিসেবে বসিও না। লাইনে "প্রশ্ন ব্যাংক"/"প্রশ্ন ও সমাধান"/"সালের প্রশ্ন"/"সংকলন"/"গাইড"/"সাজেশন" থাকলে সেটা masthead, উপেক্ষা করো — আসল designation একটা বাস্তব চাকরির পদবী (সহকারী/কর্মকর্তা/শিক্ষক/চালক/পরিদর্শক/ক্লার্ক/অফিসার ইত্যাদি) যার পাশে "পদে নিয়োগ" লেখা থাকে, আর institution একটা বাস্তব প্রতিষ্ঠান/দপ্তর/ব্যাংকের নাম। উদাহরণ: "অর্কিড বিগত সালের প্রশ্ন ব্যাংক / পল্লী সঞ্চয় ব্যাংক / ক্যাশ সহকারী পদে নিয়োগ ২০১৮" থাকলে → designation="ক্যাশ সহকারী", institution="পল্লী সঞ্চয় ব্যাংক" (প্রথম লাইন masthead, বাদ)।
